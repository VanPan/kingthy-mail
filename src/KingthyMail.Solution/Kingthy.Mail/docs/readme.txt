...
使用许可：
Kingthy.Mail库采用LGPL开源许可协议，因此您可以自由修改源代码但也必须将修改后的代码以LGPL协议开源；或你可通过第三方库文件引用方式集成在您的商业程序中而不需要公布您的商业程序代码。
LGPL许可保障原作者的知识产权，去除Kingthy.Mail库的原有特征(文件名、变量函数名等)或抄袭程序代码都是违法的，请您尊重原作者的劳动成果。
